...
import hexdoc_hex_chalkcircles

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class Hex_chalkcirclesPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return Hex_chalkcirclesModPlugin(branch=branch)


class Hex_chalkcirclesModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hex_chalkcircles"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hex_chalkcircles, "_templates"
